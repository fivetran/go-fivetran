...
type TeamGroupMembershipModifyResponse struct {
...
func (s *TeamGroupMembershipModifyService) Do(ctx context.Context) (TeamGroupMembershipModifyResponse, error) {
    var response TeamGroupMembershipModifyResponse
