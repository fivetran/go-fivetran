...
func prepareDestinationModifyResponse() string {
	...
	}`, DESTINATION_MODIFY_ID, DESTINATION_MODIFY_ID, DESTINATION_MODIFY_SERVICE, DESTINATION_MODIFY_REGION, DESTINATION_MODIFY_TIME_ZONE_OFFSET, DESTINATION_MODIFY_SETUP_STATUS,
		DESTINATION_MODIFY_TEST_TITLE_HOST, DESTINATION_MODIFY_TEST_STATUS_PASSED,
		DESTINATION_MODIFY_TEST_TITLE_DB, DESTINATION_MODIFY_TEST_STATUS_PASSED,
		DESTINATION_MODIFY_TEST_TITLE_PERM, DESTINATION_MODIFY_TEST_STATUS_PASSED,
		DESTINATION_MODIFY_HOST, DESTINATION_MODIFY_PORT, DESTINATION_MODIFY_DATABASE, DESTINATION_MODIFY_AUTH, DESTINATION_MODIFY_USER, DESTINATION_MODIFY_MASKED)
}
