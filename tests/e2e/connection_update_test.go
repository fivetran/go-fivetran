...
func TestNewConnectionUpdateE2E(t *testing.T) {
	...
	updated, err := testutils.Client.NewConnectionUpdate().ConnectionID(ConnectionId).
		Paused(true).
	...
	testutils.AssertEqual(t, updated.Data.ID, ConnectionId)
