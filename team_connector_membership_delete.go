...
type TeamConnectorMembershipDeleteResponse struct {
...
func (s *TeamConnectorMembershipDeleteService) Do(ctx context.Context) (TeamConnectorMembershipDeleteResponse, error) {
    var response TeamConnectorMembershipDeleteResponse
