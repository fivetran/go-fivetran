...
func TestNewConnectorColumnConfigModifyServiceMock(t *testing.T) {
	...
	handler := mockClient.When(http.MethodPatch, fmt.Sprintf("/v1/connectors/%v/schemas/schema_1/tables/table_1/columns/column_1", testutils.TEST_CONNECTOR_ID)).ThenCall(
