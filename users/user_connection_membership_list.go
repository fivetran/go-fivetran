...
// UserConnectionMembershipsListService implements the User Management, List all connection memberships
// Ref. https://fivetran.com/docs/rest-api/users#listallconnectionmemberships
