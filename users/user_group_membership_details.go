...
// UserGroupMembershipDetailsService implements the User Management, Retrieve group membership
// Ref. https://fivetran.com/docs/rest-api/users#retrievegroupmembership
