...
type TeamConnectorMembershipModifyResponse struct {
...
func (s *TeamConnectorMembershipModifyService) Do(ctx context.Context) (TeamConnectorMembershipModifyResponse, error) {
    var response TeamConnectorMembershipModifyResponse
